            ...
            if array_tape[current_cell] == 0:
                ...
                while loop > 0:
                    ...
                    if current_command == '[':
                        ...
                        loop -= 1
                    elif current_command == '-' and code_list[command+1] == ']':
...
def main():
    print("Basic Brainf**k Programming Language Interpreter (C) Nicholas Gray 2017")
    start_script = script_input()
    command_script(start_script)
